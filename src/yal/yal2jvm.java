...
if (jjtc000) {
 ...
 try {SimpleNode currentNode = (SimpleNode) node;
  ...
  static String squaredFrame(Object object) throws ParseException {/*@bgen(jjtree) squaredFrame */
 ASTsquaredFrame jjtn000 = new ASTsquaredFrame(JJTSQUAREDFRAME);
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);
 try {ByteArrayOutputStream outStream = new ByteArrayOutputStream();
    ...
    return outStream.toString();/*@bgen(jjtree)*/
 } finally {
   if (jjtc000) {
     jjtree.closeNodeScope(jjtn000, true);
   }
